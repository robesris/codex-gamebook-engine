...
|---|---|---|
| `codex.schema.json` (GBF format) | ≥ 1.6.0 | `github.com/robesris/codex-gamebook-engine/codex.schema.json` |
| `cli-emulator/play.js` | ≥ 3.1.0 | `github.com/robesris/codex-gamebook-engine/cli-emulator/play.js` |
| `cli-emulator/replay.js` | ≥ 3.1.0 | `github.com/robesris/codex-gamebook-engine/cli-emulator/replay.js` |
| `index.html` (browser emulator) | ≥ 3.1.0 | `github.com/robesris/codex-gamebook-engine/index.html` |
